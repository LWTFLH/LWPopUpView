...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"popBg.png"]];
       ...
       // self.backView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"popBg.png"]];
     ...
     //   self.backView.backgroundColor = [UIColor whiteColor];
        ...
        self.tfPin.placeholder = @"验证码";
 
        [self addSubview:self.tfPin];
        self.tfPin.keyboardType = UIKeyboardTypeNumberPad;
        //[self sendSubviewToBack:self.tfPin];
        
        [self.tfPin mas_makeConstraints:^(MASConstraintMaker *make) {
            make.size.mas_equalTo(CGSizeMake(200, 20));
            make.leading.mas_equalTo(10);
            make.top.mas_equalTo(self.lblPhone.mas_bottom);
        }];
        [self startCountDown];
    }
